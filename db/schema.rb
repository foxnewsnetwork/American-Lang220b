...
ActiveRecord::Schema.define(:version => 20111224002806) do
  ...
  add_index "corporations", ["email"], :name => "index_corporations_on_email", :unique => true
  add_index "corporations", ["name"], :name => "index_corporations_on_name"
  add_index "corporations", ["reset_password_token"], :name => "index_corporations_on_reset_password_token", :unique => true
